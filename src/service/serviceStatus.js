...
const products = [
    ...
    new Product("ccd", "Core Case Data", [
        ...
        new ServiceTemplate("ccd-test-stubs-service", env => `http://ccd-test-stubs-service-${env}.service.core-compute-${env}.internal`, [ Environment.DEMO, Environment.AAT, Environment.ITHC, Environment.PERFTEST ]),
            ...
            services.forEach(service => {
                ...
                new Promise((resolve, reject) => {
                    ...
                    .catch((e) => {
                        ...
                        if (service.failedChecks >= 5 && !service.reportedDown) {
