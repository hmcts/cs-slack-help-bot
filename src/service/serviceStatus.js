...
const products = [
    ...
    new Product("fees-pay", "Fee & Payments", [
        new ServiceTemplate("bar-api", env => `http://bar-api-${env}.service.core-compute-${env}.internal`, [ Environment.PROD, Environment.AAT, Environment.DEMO, Environment.PERFTEST ]),
        new ServiceTemplate("bar-web", env => prodOverride(env, `https://manage-payments.platform.hmcts.net`, `https://bar.${env}.platform.hmcts.net`), [ Environment.PROD, Environment.AAT, Environment.DEMO, Environment.PERFTEST ]),
